...
public class Space {
	...
	public static Space getInstance() {
         ...
         * Initializes a new HashMap used to store information
         * which blocks trigger which agents. Keys are of type String and 
         * represent the masks of blocks and values are of type ArrayList
	...
	protected Space() {
        ...
        /**
         * Method used for writing to Space.
         * Also triggers all agents attached to the block which is being written into.
	...
	public Object read (String name, Object def) {
        ...
        /**
         * Method used for attaching triggerable agents to blocks.
         * Attaches an agent to a block, so that it triggers when a given block 
         * is written into. 
